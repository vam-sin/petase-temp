...
# dataset import 
ds = pd.read_csv('seq_temp_all.csv')
...
# maximum sequence length is 7073 residues in the ds
...
# callbacks
mcp_save = keras.callbacks.ModelCheckpoint('saved_models/cnn_oh_pet_all.h5', save_best_only=True, monitor='val_mse', verbose=1)
